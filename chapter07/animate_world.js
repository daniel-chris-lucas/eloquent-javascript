(function () {
    ...
    function Animated(world) {
        ...
        node.style.cssText = "position: relative; width: inherit; width: fit-content;";
        ...
        this.button.style.cssText = "position: absolute; bottom: 8px; right: -4.5em; " +
            "color: white; font-family: tahoma, arial; background: #4ab; cursor: pointer; " +
            "border-radius: 18px; font-size: 70%; width: 3.5em; text-align: center;";
